...
typedef void                       (^OCLazyTableViewCellWillDisplayBlock)    (id _Nonnull model, UITableView * _Nonnull tableView);
typedef void                       (^OCLazyTableViewCellDidSelectBlock)      (id _Nonnull model, UITableView * _Nonnull tableView);
